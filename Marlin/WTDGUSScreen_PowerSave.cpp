...
void DGUS_Screen_PowerSave::Init()
{
	...
	dserial.SendString_P(ADDR_SPEED_TEXT_TITLE, MMSG_POWER_SAVE_TITLE[wtvar_language], 30);
	...
	dserial.SendString_P(ADDR_SPEED_TEXT1, MMSG_POWEROFF_VALUE1[wtvar_language], 15);
	dserial.SendString_P(ADDR_SPEED_TEXT2, MMSG_POWEROFF_VALUE2[wtvar_language], 15);
	dserial.SendString_P(ADDR_SPEED_TEXT3, MMSG_POWEROFF_VALUE3[wtvar_language], 15);
	dserial.SendString_P(ADDR_SPEED_TEXT4, MMSG_POWEROFF_VALUE4[wtvar_language], 15);
	dserial.SendString_P(ADDR_SPEED_TEXT5, MMSG_POWEROFF_VALUE5[wtvar_language], 15);
	dserial.SendString_P(ADDR_SPEED_TEXT6, MMSG_POWEROFF_VALUE6[wtvar_language], 15);
...
void DGUS_Screen_PowerSave::ShowHelp(void)
{
	...
	dserial.SendString_P(ADDR_HELP1_TEXT_LINE1, HELP_TIP14_LINE1[wtvar_language], 60);
	dserial.SendString_P(ADDR_HELP1_TEXT_LINE2, HELP_TIP14_LINE2[wtvar_language], 60);
	dserial.SendString_P(ADDR_HELP1_TEXT_LINE3, HELP_TIP14_LINE3[wtvar_language], 60);
	dserial.SendString_P(ADDR_HELP1_TEXT_LINE4, HELP_TIP14_LINE4[wtvar_language], 60);
	dserial.SendString_P(ADDR_HELP1_TEXT_LINE5, HELP_TIP14_LINE5[wtvar_language], 60);
	dserial.SendString_P(ADDR_HELP1_TEXT_LINE6, HELP_TIP14_LINE6[wtvar_language], 60);
	dserial.SendString_P(ADDR_HELP1_TEXT_LINE7, HELP_TIP14_LINE7[wtvar_language], 60);
}
