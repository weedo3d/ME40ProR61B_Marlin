...
void report_current_position();
  ...
  #define PSU_PIN_OFF() do{ OUT_WRITE(PS_ON_PIN, PS_ON_ASLEEP); delay(500);  OUT_WRITE(PS_ON_PIN, PS_ON_AWAKE); delay(500); powersupply_on = false; }while(0) 
#endif
...
#ifdef AUTOPOWEROFF
extern void setup_autopoweroffhi(void);
extern void setup_autopowerofflo(void); 
#endif
...
extern bool printoverinfoscreenflag;
extern float zoffset_forjust; 
...
extern inline void line_to_destination(float fr_mm_s);
